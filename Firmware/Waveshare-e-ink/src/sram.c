...
// It ships an IS62WV51216BLL - 55ns speed grade (1MB RAM, 512K * 16)
...
void FSMC_SRAM_Init() {
	...
	FSMC_NORSRAMStructInit(&sram);

	timing.FSMC_AddressSetupTime = 8;   // 45 ns ~3.12 cycles
	timing.FSMC_AddressHoldTime = 0;
	timing.FSMC_DataSetupTime = 8;      // 45 ns ~3.12 cycles
